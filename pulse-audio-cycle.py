        ...
        if card.index == current_card_index:
            ...
            if not profile_names:
                ...
                if current_card_profile_name == profile_names[-1]:
                    ...
                    new_card = card
                    new_profile_index = (
                        profile_names.index(current_card_profile_name) + 1
                    )
...
def main(args):
        ...
        for profile in card.profile_list:
            ...
            for cp_card_pattern, cp_profile_pattern in args.profile:
                ...
                if re.search(cp_card_pattern, card.name):
                    ...
                    if sink_for_current_card:
                        if re.search(
                            cp_card_pattern, sink_for_current_card.description
                        ):
                            cp_card_pattern_matched = True
    ...
    new_card, new_profile = new_card_and_profile(matching_cards_with_profiles, pulse)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help=(
            "With regex_for_card regex_for_profile_the_card_should_get. "
    ...
    parser.add_argument(
        ...
        metavar="CARD_REGEX",
        help=(
            "Regex pattern of cards to cylce through. "
    ...
    parser.add_argument(
        ...
        default=False,
        help=(
            "Instead of only looking at card names, also match regex against "
            "sink description"
        ),
    )
    parser.add_argument(
